	...
	<div class="site-logo">
		...
		<div class="site-branding<?php if ( is_singular() ) { echo ' screen-reader-text '; } ?>">
			...
			if ( $travel_blog_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $travel_blog_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->

		<nav id="site-navigation" class="main-navigation">
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Menu', 'travel-blog' ); ?></button>
			<?php
			wp_nav_menu( array(
